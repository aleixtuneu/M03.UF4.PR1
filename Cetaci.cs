...
namespace M03.UF4.PR1
{
    ...
    {
        public Cetaci(string family, double Agrade, string location, string animalName, string specie, double weight, string date, int rescueNumber)
        {
            this.Family = family;
            this.AG = Agrade;
