...
namespace M03.UF4.PR1
{
    ...
    {
        public TortugaMarina(string family, double Agrade, string location, string animalName, string specie, double weight, string date, int rescueNumber)
        {
            this.Family = family;
            this.AG = Agrade;
        ...
        public override double GetWeight()
        {
            ...
            this.Weight = randomWeight.Next(60, 150);
            return Weight;
        }
